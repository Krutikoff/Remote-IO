...
void common_exti_handler()
{
    ...
    for (uint8_t i = static_cast<uint8_t>(GpioModule::Address::PIN0);
...
void GpioModule::_latch_clear()
{
    ...
    GpioModule::LatchStatus clear_low[8] = {
      GpioModule::LatchStatus::HIGH, GpioModule::LatchStatus::HIGH,
      GpioModule::LatchStatus::HIGH, GpioModule::LatchStatus::HIGH,
      GpioModule::LatchStatus::HIGH, GpioModule::LatchStatus::HIGH,
      GpioModule::LatchStatus::HIGH, GpioModule::LatchStatus::HIGH};
